...
Ouvrez `index.html` dans votre navigateur ou servez le projet avec un serveur local :

```bash
npx http-server . -p 8080
```

Le site est désormais un site vitrine statique, sans backend. Les demandes de contact s'effectuent via votre messagerie ou WhatsApp.
